...
export default function App(){
 ...
 const[rapportsSite,setRapportsSite0]=useState([]);const[intendance,setIntendance0]=useState([]);const[suiviEduc,setSuiviEduc0]=useState([]);const[purgeMarks,setPurgeMarks]=useState({});const[notifs,setNotifs0]=useState([]);const[transmissions,setTransmissions0]=useState([]);const[notifOpen,setNotifOpen]=useState(false);
