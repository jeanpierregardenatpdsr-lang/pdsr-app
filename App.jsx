...
const inPurgeRanges=(ranges,typeName,x)=>Array.isArray(ranges)&&ranges.some(r=>r&&Array.isArray(r.t)&&r.t.includes(typeName)&&x&&x.date>=r.from&&x.date<=r.to&&((x.updatedAt||x.createdAt||"")<r.ts));
