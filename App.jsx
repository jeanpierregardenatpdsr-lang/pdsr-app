    ...
    {tab==="logs"&&<div>
      ...
      {logTab==="connexions"&&<div>
        <div style={{display:"flex",gap:8,marginBottom:10,flexWrap:"wrap"}}>
          ...
          <button onClick={()=>{if(confirm("Purger tous les logs de connexion ? (irréversible)"))onPurgeLogs();}} style={{padding:"5px 12px",borderRadius:8,border:"1px solid #C62828",background:"#FFEBEE",color:"#C62828",fontWeight:600,fontSize:12,cursor:"pointer",fontFamily:"inherit"}}>Purger</button>
        </div>
      ...
      {logTab==="suppressions"&&<div>
        <div style={{display:"flex",gap:8,marginBottom:10,flexWrap:"wrap"}}>
          ...
          <button onClick={()=>{if(confirm("Purger tous les logs de suppression ? (irréversible)"))onPurgeDeletionLogs();}} style={{padding:"5px 12px",borderRadius:8,border:"1px solid #C62828",background:"#FFEBEE",color:"#C62828",fontWeight:600,fontSize:12,cursor:"pointer",fontFamily:"inherit"}}>Purger</button>
        </div>
        <div style={{...S.card,maxHeight:400,overflowY:"auto"}}>
